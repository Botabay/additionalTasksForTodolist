...
function AppWithRedux() {
    //very bad code:
    // let state=useSelector<AppRootStateType,Array<TodolistType>>(state=>state.todolists)
    // let todo =state.todolists;
    // let t =state.tasks;
    ...
    function changeFilter(value: FilterValuesType, todolistId: string) {
        ...
        //     dispatchTasks(changeTodolistFilterAC(value,todolistId))//?
        // }
    ...
    function changeTodolistTitle(id: string, title: string) {
        ...
        //     dispatchTodolists(changeTodolistTitleAC(todolist.id,title));
        // }
